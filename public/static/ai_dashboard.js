...
async function showAiDashboard(tid) {
  ...
  `, null, { confirmText: '닫기', wide: true, hideCancel: true });
    ...
    try {
        // 병렬 데이터 Fetch
        const [dashboard, leaderboard, events] = await Promise.all([
        ...
        const html = renderAiDashboardHtml(tid, overall, completionRate, eventStats, clubStats, lb, groupAnalysis, events);
...
function renderAiDashboardHtml(tid, overall, completionRate, eventStats, clubStats, leaderboard, groupAnalysis, events) {
